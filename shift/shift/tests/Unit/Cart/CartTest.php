...
class CartTest extends TestCase
{
    ...
    public function test_it_increments_quantity_when_more_products_added_to_cart()
    {
        // Create a product variation
        $product = factory(ProductVariation::class)->create();

        // Create a new cart using a dummy user (to pass into the method)
        $cart = new Cart(
            $user = factory(User::class)->create()
        );
        ...
        // Create new instance of cart, to add product twice, using the same user.
    ...
    public function test_it_can_check_if_cart_is_empty_of_quantities()
    {
        $cart = new Cart(
            $user = factory(User::class)->create()
        );
    ...
    public function test_it_can_check_if_cart_has_changed_after_syncing()
    {
        $cart = new Cart(
            $user = factory(User::class)->create()
        );
